...
u16 *
hamfake_lockRawScreen()
{
  return glb_rawscreen;
}
...
ham_Init()
{
  ...
  if (fp)
  {
    ...
    const char *setname[NUM_TILESETS] =
    {
	"akoimeexx", //default
	"classic",
	"adambolt",
  ...
  for(int tilecount=0;tilecount<NUM_TILESETS-1;tilecount++)
	bmp_loadTileset(setname[tilecount], tilecount);
